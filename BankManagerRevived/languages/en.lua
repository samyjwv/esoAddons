...
local lang = {
	...
	BMR_DONT_MOVE_PROTECTED_ITEMS_TOOLTIP	= "Don't move items marked by ItemSaver or FCO ItemSaver",
	BMR_DONT_MOVE_PROTECTED_ITEMS_EXT		= " - Option disabled, addons are not detected",
	...
	BMR_TROPHY_IMPERIALCITY_PVP				= "Imperial City PVP Trophies",
	BMR_TROPHY_IMPERIALCITY_PVE				= "Imperial City PVE Trophies",
