...
SafeAddString(BMR_DONT_MOVE_PROTECTED_ITEMS_TOOLTIP	, "Ne pas déplacer les objets protégés par ItemSaver ou FCO ItemSaver", 1)
SafeAddString(BMR_DONT_MOVE_PROTECTED_ITEMS_EXT			, " - Option désactivée, les addons ne sont pas détectés", 1)
...
SafeAddString(BMR_TROPHY_IMPERIALCITY_PVP					, "Trophées PVP de la Cité Impériale", 1)
SafeAddString(BMR_TROPHY_IMPERIALCITY_PVE					, "Trophées PVE de la Cité Impériale", 1)
