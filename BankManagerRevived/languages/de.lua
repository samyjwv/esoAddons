...
SafeAddString(BMR_DONT_MOVE_PROTECTED_ITEMS_TOOLTIP	, "Items markiert von ItemSaver oder FCO Itemsaver nicht verlagern.", 1)
SafeAddString(BMR_DONT_MOVE_PROTECTED_ITEMS_EXT			, " Addons werden nicht erkannt wenn Deaktiviert.", 1)
...
--SafeAddString(BMR_TROPHY_IMPERIALCITY_PVP					, "Imperial City PVP Trophies", 1)
--SafeAddString(BMR_TROPHY_IMPERIALCITY_PVE					, "Imperial City PVE Trophies", 1)
