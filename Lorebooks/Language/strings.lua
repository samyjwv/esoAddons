local strings = {
	...
	LBOOKS_THANK_YOU3100				= "Another one",
	LBOOKS_THANK_YOU_LONG3100		= "And you already know where the missings are",
	
	LBOOKS_THANK_YOU3174				= "Congratulations",
	LBOOKS_THANK_YOU_LONG3174		= "There is no one else like you",
