...
_addon.Feature.Toolbar.GetXP = function()
    ...
    if setting == "Earned / Total" then
        if useCommas then return title .._addon:comma_value(xp).."|cA0A0CF / |r".."|cA0A0CF".._addon:comma_value(xplvl).."|r", c;
    ...
    if setting == "Earned % / Total" then
        if useCommas then return title .._addon:Round((xp/xplvl)*100,0).."%|cA0A0CF / |r".."|cA0A0CF".._addon:comma_value(xplvl).."|r", c;
        else return title .._addon:Round((xp/xplvl)*100,0).."%|cA0A0CF / |r".."|cA0A0CF"..xplvl.."|r", c; end
    end
